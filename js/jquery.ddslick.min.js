(function(a) {
    ...
    var b = {},
        ...
        f = '<style id="css-ddslick" type="text/css">' + ".dd-select{ position:relative; cursor:pointer; text-align:right; }" + ".dd-desc { color:#ffffff; display:block; overflow: hidden; font-weight:300; line-height: 15pt; font-size:12pt; font-family: 'Segoe UI Light_', 'Open Sans Light', Verdana, Arial, Helvetica, sans-serif;}" + ".dd-selected{ overflow:hidden; display:block; padding:10px; font-weight:300; width:200px}" + ".dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}" + ".dd-pointer-down{ border:solid 10px transparent; border-top:solid 10px #ffffff; }" + ".dd-pointer-up{border:solid 10px transparent !important; border-bottom:solid 10px #ffffff !important; margin-top:-8px;}" + ".dd-options{ border-top:none; list-style:none; display:none; position:absolute; z-index:2000; margin:0; padding:0; overflow:auto;}" + ".dd-option{ padding:10px; display:block; overflow:hidden; text-decoration:none; color:#ffffff; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }" + ".dd-options > li:last-child > .dd-option{ border-bottom:none;}" + ".dd-option:hover{ }" + ".dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }" + ".dd-option-selected {  }" + ".dd-option-image, .dd-selected-image { vertical-align:middle; float:right; margin-left:5px; max-width:64px;}" + ".dd-image-right { float:right; margin-right:15px; margin-left:15px;}" + ".dd-container{ position:relative;}​ .dd-selected-text { font-weight:300}​</style>";
