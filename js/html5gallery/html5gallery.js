 ...
 */
(function() {
    for (var p = document.getElementsByTagName("script"), s = "", k = 0; k < p.length; k++) p[k].src && p[k].src.match(/html5gallery\.js/i) && (s = p[k].src.substr(0, p[k].src.lastIndexOf("/") + 1));
    p = !1;
    if ("undefined" == typeof jQuery) p = !0;
    else if (k = jQuery.fn.jquery.split("."), 1 > k[0] || 1 == k[0] && 6 > k[1]) p = !0;
    if (p) {
        ...
        q.readyState ? q.onreadystatechange = function() {
            if ("loaded" == q.readyState || "complete" ==
                q.readyState) q.onreadystatechange = null, loadHtml5Gallery(s)
        } : q.onload = function() {
            loadHtml5Gallery(s)
        };
        q.setAttribute("src", s + "jquery.js");
        p.appendChild(q)
...
function loadHtml5Gallery(p) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(c, e, a, d, b) {
            ...
            if (1 == (e /= b)) return a + d;
            n || (n = 0.3 * b);
            h < Math.abs(d) ? (h = d, c = n / 4) : c = n / (2 * Math.PI) * Math.asin(d / h);
            return -(h * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * b - c) * 2 * Math.PI / n)) + a
        },
        easeOutElastic: function(c,
            ...
            n || (n = 0.3 * b);
            h < Math.abs(d) ? (h = d, c = n / 4) : c = n / (2 * Math.PI) * Math.asin(d / h);
            return h * Math.pow(2, -10 * e) * Math.sin((e * b - c) * 2 * Math.PI / n) + d + a
        },
        easeInOutElastic: function(c, e, a, d, b) {
            ...
            n || (n = b * 0.3 * 1.5);
            h < Math.abs(d) ? (h = d, c = n / 4) : c = n / (2 * Math.PI) * Math.asin(d / h);
            return 1 > e ? -0.5 * h * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * b - c) * 2 * Math.PI / n) + a : 0.5 * h * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * b - c) * 2 * Math.PI /
                n) + d + a
        },
        easeInBack: function(c, e, a, d, b, n) {
            void 0 == n && (n = 1.70158);
            return d * (e /= b) * e * ((n + 1) * e - n) + a
        },
        easeOutBack: function(c, e, a, d, b, n) {
            void 0 == n && (n = 1.70158);
            return d * ((e = e / b - 1) * e * ((n + 1) * e + n) + 1) + a
        },
        easeInOutBack: function(c, e, a, d, b, n) {
            void 0 == n && (n = 1.70158);
            return 1 > (e /= b / 2) ? d / 2 * e * e * (((n *= 1.525) + 1) * e - n) + a : d / 2 * ((e -= 2) * e * (((n *= 1.525) + 1) * e + n) + 2) + a
        },
        ...
        return this.each(function() {
            function a(a) {
                ...
                1 <= b.targetTouches.length ?
                    (h = b.targetTouches[0].pageX, l = b.targetTouches[0].pageY) : c(a)
            }
            ...
            function b(a) {
                if (0 < f || 0 < y) 100 < Math.abs(f - h) && (f > h ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()), 100 < Math.abs(y - l) && (y > l ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                c(a)
            }
            ...
            var h = -1,
                ...
                y = -1;
            try {
                s(this).bind("touchstart",
                    a), s(this).bind("touchmove", d), s(this).bind("touchend", b), s(this).bind("touchcancel", c)
            } catch (g) {}
        })
    };
    var k = jQuery;
    k.fn.drag = function(c, e, a) {
        var d = "string" == typeof c ? c : "",
            b = k.isFunction(c) ? c : k.isFunction(e) ? e : null;
        ...
        j = r.drag = {
            ...
            add: function(c) {
                var e = k.data(this,
                    ...
                    a = c.data || {};
                e.related += 1;
                !e.live && c.selector && (e.live = !0, q.add(this, "draginit." + j.livekey, j.delegate));
                k.each(j.defaults, function(d) {
                    void 0 !== a[d] && (e[d] = a[d])
                })
            },
            remove: function() {
                k.data(this, j.datakey).related -= 1
            },
            setup: function() {
                if (!k.data(this, j.datakey)) {
                    var c = k.extend({
                        related: 0
                    }, j.defaults);
                    k.data(this, j.datakey, c);
                    q.add(this, "mousedown", j.init, c);
                    this.attachEvent && this.attachEvent("ondragstart", j.dontstart)
                }
            },
            teardown: function() {
                k.data(this, j.datakey).related || (k.removeData(this,
                    j.datakey), q.remove(this, "mousedown", j.init), q.remove(this, "draginit", j.delegate), j.textselect(!0), this.detachEvent && this.detachEvent("ondragstart", j.dontstart))
            },
            init: function(c) {
                var e = c.data,
                    a;
                if (!(0 < e.which && c.which != e.which) && !k(c.target).is(e.not) && (!e.handle || k(c.target).closest(e.handle, c.currentTarget).length))
                    if (e.propagates = 1, e.interactions = [j.interaction(this, e)], e.target = c.target, e.pageX = c.pageX, e.pageY = c.pageY, e.dragging = null, a = j.hijack(c, "draginit", e), e.propagates) {
                        if ((a = j.flatten(a)) &&
                            a.length) e.interactions = [], k.each(a, function() {
                            e.interactions.push(j.interaction(this, e))
                        });
                        e.propagates = e.interactions.length;
                        !1 !== e.drop && r.drop && r.drop.handler(c, e);
                        j.textselect(!1);
                        q.add(document, "mousemove mouseup", j.handler, e);
                        return !1
                    }
            },
            interaction: function(c, e) {
                return {
                    ...
                    droppable: [],
                    offset: k(c)[e.relative ? "position" : "offset"]() || {
                        top: 0,
                        left: 0
                    }
                }
            ...
            handler: function(c) {
                ...
                switch (c.type) {
                    ...
                    case "mouseup":
                        q.remove(document, "mousemove mouseup", j.handler), e.dragging && (!1 !== e.drop && r.drop && r.drop.handler(c, e), j.hijack(c, "dragend", e)), j.textselect(!0), !1 === e.click && e.dragging && (jQuery.event.triggered = !0, setTimeout(function() {
            ...
            delegate: function(c) {
                var e = [],
                    a, d = k.data(this, "events") || {};
                k.each(d.live || [], function(b, d) {
                    if (0 === d.preType.indexOf("drag") && (a = k(c.target).closest(d.selector, c.currentTarget)[0])) q.add(a, d.origType + "." + j.livekey, d.origHandler, d.data), 0 > k.inArray(a, e) && e.push(a)
                });
                return !e.length ? !1 : k(e).bind("dragend." + j.livekey, function() {
                    q.remove(this, "." + j.livekey)
                })
            },
            hijack: function(c, e, a, d, b) {
                if (a) {
                    var n = c.originalEvent,
                        h = c.type,
                        l = e.indexOf("drop") ? "drag" : "drop",
                        f, w = d || 0,
                        g, p;
                    d = !isNaN(d) ?
                    ...
                    a.results = [];
                    do
                        if ((g = a.interactions[w]) && !("dragend" !== e && g.cancelled)) p = j.properties(c, a, g), g.results = [], k(b || g[l] || a.droppable).each(function(b, d) {
                                f = (p.target = d) ? q.handle.call(d, c, p) : null;
                                !1 === f ? ("drag" == l && (g.cancelled = !0, a.propagates -= 1), "drop" == e && (g[l][b] = null)) : "dropinit" == e && g.droppable.push(j.element(f) || d);
                                "dragstart" == e && (g.proxy = k(j.element(f) || g.drag)[0]);
                                g.results.push(f);
                                delete c.result;
                                if ("dropinit" !== e) return f
                            }), a.results[w] =
                            j.flatten(g.results), "dropinit" == e && (g.droppable = j.flatten(g.droppable)), "dragstart" == e && !g.cancelled && p.update();
                    while (++w < d);
                    c.type = h;
                    c.originalEvent = n;
            ...
            flatten: function(c) {
                return k.map(c, function(c) {
                    return c && c.jquery ? k.makeArray(c) : c && c.length ? j.flatten(c) : c
                })
            },
            textselect: function(c) {
                k(document)[c ? "unbind" : "bind"]("selectstart", j.dontstart).attr("unselectable", c ? "off" : "on").css("MozUserSelect", c ? "" : "none")
            },
            dontstart: function() {
                return !1
            },
    ...
    j.callback.prototype = {
        update: function() {
            r.drop && this.available.length &&
                k.each(this.available, function(c) {
                    r.drop.locate(this, c)
                })
        }
    };
    r.draginit = r.dragstart = r.dragend = j;
    var z = jQuery;
    z.fn.html5boxTransition = function(c, e, a, d, b) {
        ...
        f && d[f] && (d[f].duration && (h = d[f].duration), d[f].easing && (n = d[f].easing));
        "fade" == f ? (a.hide(), e.insertBefore(a), a.fadeIn(h, n, function() {
            e.remove();
            b()
        })) : "crossfade" == f || "fadeout" == f ? (a.hide(),
            e.fadeOut(h / 2, n, function() {
                a.fadeIn(h / 2, n, function() {
                    e.remove();
                    b()
                })
            })) : "slide" == f ? ($parent.css({
    ...
    g.fn.addHTML5VideoControls = function(c, e) {
        ...
        setInterval(function() {
            k && (t.show(), k = !1, clearTimeout(f), f = setTimeout(function() {
                m.get(0).paused || t.fadeOut()
            }, 5E3))
        }, 250);
        g(".html5boxVideoControlsBg", t).css({
            display: "block",
            position: "absolute",
            width: "100%",
            height: "100%",
        ...
        g(".html5boxPlayPause", t).css({
            display: "block",
            position: "relative",
            width: "32px",
            height: "32px",
            margin: Math.floor((l - 32) / 2),
            "float": "left"
        });
        var H = g(".html5boxPlay", t),
            I = g(".html5boxPause", t);
        H.css({
            display: "block",
            position: "absolute",
        ...
        var C = g(".html5boxTimeCurrent", t),
            L = g(".html5boxTimeTotal",
                t),
            u = g(".html5boxSeeker", t),
            E = g(".html5boxSeekerPlay", t),
            M = g(".html5boxSeekerBuffer", t),
            O = g(".html5boxSeekerHandler", t);
        C.css({
            display: "block",
            position: "relative",
            "float": "left",
        ...
        u.css({
            ...
            margin: Math.floor((l - 10) / 2) + "px 4px"
        }).bind(d, function(c) {
            c = (a ? c.originalEvent.touches[0] : c).pageX - u.offset().left;
            E.css({
                width: c
            });
            m.get(0).currentTime = c * m.get(0).duration / u.width();
            u.bind(b, function(b) {
                b = (a ? b.originalEvent.touches[0] : b).pageX - u.offset().left;
                E.css({
                    width: b
                });
                m.get(0).currentTime = b * m.get(0).duration / u.width()
            })
        }).bind(n, function() {
            u.unbind(b)
        });
        ...
        if (!p && (m.get(0).requestFullscreen || m.get(0).webkitRequestFullScreen || m.get(0).mozRequestFullScreen || m.get(0).webkitEnterFullScreen || m.get(0).msRequestFullscreen)) {
            var J = function(a) {
                ...
                a ? (g(document).bind("mousemove", z), t.css({
                    "z-index": 2147483647
                })) : (g(document).unbind("mousemove", z), t.css({
                    "z-index": ""
                }))
            };
            ...
            A.css({
                ...
                (j = !j) ? (m.get(0).requestFullscreen ? m.get(0).requestFullscreen() : m.get(0).webkitRequestFullScreen ?
        ...
        s &&
            g(".html5boxHD", t).css({
                ...
                "background-position": (q ? "right" : "left") + " center"
            }).bind(h, function() {
                q = !q;
                g(this).css({
                    "background-position": (q ? "right" : "left") + " center"
                ...
                m.get(0).setAttribute("src", (q ? s : r) + "#t=" + m.get(0).currentTime);
                a ? p || m.get(0).pause() : m.get(0).play()
            });
        x = m.get(0).volume;
        m.get(0).volume =
            x / 2 + 0.1;
        if (m.get(0).volume === x / 2 + 0.1) {
            m.get(0).volume = x;
            var x = g(".html5boxVolume", t),
                F = g(".html5boxVolumeButton", t),
                K = g(".html5boxVolumeBar", t),
                v = g(".html5boxVolumeBarBg", t),
                B = g(".html5boxVolumeBarActive", t);
            x.css({
                display: "block",
                position: "relative",
                "float": "right",
            ...
            K.css({
                ...
                width: 24,
                height: 80,
                "margin-bottom": Math.floor((l - 32) / 2),
                "background-color": "#000000",
                opacity: 0.7,
                filter: "alpha(opacity=70)"
            });
            ...
            v.bind(d, function(c) {
                c = 1 - ((a ? c.originalEvent.touches[0] : c).pageY - v.offset().top) / v.height();
                c = 1 < c ? 1 : 0 > c ? 0 : c;
                B.css({
                ...
                v.bind(b,
                    function(b) {
                        b = 1 - ((a ? b.originalEvent.touches[0] : b).pageY - v.offset().top) / v.height();
                        b = 1 < b ? 1 : 0 > b ? 0 : b;
                        B.css({
        ...
        try {
            m.bind("play", function() {
                ...
                H.hide();
                I.show()
            }), m.bind("pause", d), m.bind("ended", d), m.bind("timeupdate", n), m.bind("progress",
                h)
        } catch (P) {}
    };
    var c = jQuery,
    ...
    c.fn.html5gallery = function(g) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.fv ?
                    a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.freelink + "' >" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink + "' >");
            ...
            initData: function(a) {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                    ...
                    c.ajax({
                        ...
                        success: function(d) {
                            c(d).find("slide").each(function(a) {
                                ...
                                d || (d = "");
                                e || (e = "");
                                var n = c(this).find("mediatype").text() ? c(this).find("mediatype").text() : b.checkType(c(this).find("file").text());
                                b.elemArray.push([c(this).find("id").length ?
                                    ...
                                    c(this).find("hd").text(), c(this).find("hdogg").text(), c(this).find("hdwebm").text()
                                ])
                            });
                            b.readTags();
                            a(b)
                    ...
                    for (var d = 0; d < c.length; d++) {
                        ...
                        b.elemArray.push([d, c[d].thumbnail, c[d].file, c[d].fileogg, c[d].filewebm, c[d].link, c[d].linktarget, c[d].title, c[d].description, e, c[d].width && !isNaN(parseInt(c[d].width)) ? parseInt(c[d].width) : b.options.width,
                            c[d].height && !isNaN(parseInt(c[d].height)) ? parseInt(c[d].height) : b.options.height, c[d].poster, c[d].hd, c[d].hdogg, c[d].hdwebm
                        ])
                    }
                    b.readTags();
                    a(b)
                    ...
                    d.author = this.options.youtubechannel.author : this.options.youtubechannel.q && (d.q = this.options.youtubechannel.q), d = "https://gdata.youtube.com/feeds/api/videos?" + c.param(d), b = this, c.getJSON(d, function(c) {
                        if (c && c.feed && c.feed.entry)
                            for (var d = 0; d < c.feed.entry.length; d++) b.elemArray.push([d, ("https:" == document.location.protocol ? "https:" : "http:") + "//img.youtube.com/vi/" + c.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", c.feed.entry[d].media$group.media$player.url, null, null, null, null, c.feed.entry[d].media$group.media$title.$t,
                                c.feed.entry[d].media$group.media$description.$t, 9, 640, 480, ("https:" == document.location.protocol ? "https:" : "http:") + "//img.youtube.com/vi/" + c.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", null, null, null
                            ]);
                        b.readTags();
                        a(b)
            ...
            readTags: function() {
                ...
                c("img", this.container).each(function() {
                    ...
                    var h = a.options.width,
                        ...
                        s = null,
                        r = null;
                    c(this).parent().is("a") && (d = c(this).parent().attr("href"), f = c(this).parent().data("ogg"), g = c(this).parent().data("webm"), j = c(this).parent().data("link"), k = c(this).parent().data("linktarget"), p = c(this).parent().data("poster"), isNaN(c(this).parent().data("width")) || (h = c(this).parent().data("width")), isNaN(c(this).parent().data("height")) || (l = c(this).parent().data("height")), q = c(this).parent().data("hd"), s = c(this).parent().data("hdogg"),
                        r = c(this).parent().data("hdwebm"));
                    var m = c(this).parent().data("mediatype") ? c(this).parent().data("mediatype") : a.checkType(d);
                    a.elemArray.push([a.elemArray.length, c(this).attr("src"), d, f, g, j, k, b, e, m, h, l, p, q, s, r])
                })
            },
            createMarkup: function() {
                this.$gallery = jQuery("<div class='html5gallery-container-" + this.id + "'><div class='html5gallery-box-" + this.id + "'><div class='html5gallery-elem-" + this.id + "'></div><div class='html5gallery-title-" + this.id + "'></div><div class='html5gallery-timer-" + this.id + "'></div><div class='html5gallery-viral-" +
                    this.id + "'></div><div class='html5gallery-toolbox-" + this.id + "'><div class='html5gallery-toolbox-bg-" + this.id + "'></div><div class='html5gallery-toolbox-buttons-" + this.id + "'><div class='html5gallery-play-" + this.id + "'></div><div class='html5gallery-pause-" + this.id + "'></div><div class='html5gallery-left-" + this.id + "'></div><div class='html5gallery-right-" + this.id + "'></div><div class='html5gallery-lightbox-" + this.id + "'></div></div></div></div><div class='html5gallery-car-" + this.id + "'><div class='html5gallery-car-list-" +
                ...
                c(".html5gallery-box-" + this.id, this.$gallery).hover(function() {
                    ...
                    if ("mouseover" == a.options.imagetoolboxmode) {
                        ...
                        ("always" == a.options.showimagetoolbox ||
                            "image" == a.options.showimagetoolbox && 1 == c) && a.showimagetoolbox(c)
                    }
                }, function() {
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.showcarousel && (this.options.carouselWidth = "bottom" == this.options.carouselposition ? this.options.width :
                    ...
                    if (this.options.showcarousel)
                        if ("bottom" == this.options.carouselposition) {
                            ...
                            this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding;
                    ...
                    } else if (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) a = this.elemArray[this.curElem][10], d = this.elemArray[this.curElem][11], this.isFullscreen ? (b = Math.min(this.fullscreenWidth / a, this.fullscreenHeight / d), b = 1 < b ? 1 : b, a = Math.round(b * a), b = Math.round(b * d), this.adjustFullscreen(a, b, !0)) : (a = this.options.width, b = this.options.height),
                        c(".html5gallery-elem-" + this.id).css({
                            width: a + "px",
                            height: b + "px"
                            ...
                            width: a + "px",
                            height: b + "px"
                        }), c("#html5gallery-elem-video-" + this.id).attr("width", a), c("#html5gallery-elem-video-" +
                            this.id).attr("height", b), c(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), c(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", b), c("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), c("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", b);
                    d = a = 0;
                    "bottom" == this.options.headerpos && (a = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height, d = this.options.titleoverlay ? this.options.height : this.options.height +
            ...
            createStyleVertical: function() {
                ...
                var b = b + (" .html5gallery-box-" +
                    ...
                    b = b + (" .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlecss + " .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlelinkcss),
                    b = b + (" .html5gallery-fullscreen-description-" + this.id + "" + this.options.lightboxdescriptioncss + " .html5gallery-fullscreen-description-" + this.id + "" + this.options.lightboxdescriptionlinkcss),
                    b = b + (" .html5gallery-viral-" + this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" +
                ...
                this.options.isIE7 || this.options.isIE6 ? (b += " .html5gallery-loading-" +
                    this.id + " {display:none; }", b += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (b += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading-bars.svg') no-repeat top right;}", b += " .html5gallery-loading-center-" + this.id + " {display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading_center.gif') no-repeat center center;}");
                ...
                this.options.slideshadow && (b += " .html5gallery-title-" + this.id + " { }", b += " .html5gallery-timer-" + this.id + " { margin:4px;}", b += " .html5gallery-elem-" + this.id + " { overflow:hidden; padding:4px; }");
            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    var a;
                    if ("center" == this.options.imagetoolboxstyle) a = " .html5gallery-toolbox-" +
                        ...
                        a += " .html5gallery-toolbox-buttons-" +
                            this.id + " {display:block;}";
                        a += " .html5gallery-play-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + b + "px; left:" + h + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_play.png') no-repeat top left;} ";
                        a += " .html5gallery-pause-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + b + "px; left:" + h + "px; width:48px; height:48px; background:url('" +
                            this.options.skinfolder + "side_pause.png') no-repeat top left;} ";
                        a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + d + "px; left:15px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_prev.png') no-repeat center center;} ";
                ...
                this.showimagetoolbox = function(a) {
                    if (this.options.showplaybutton || this.options.showprevbutton || this.options.shownextbutton || this.options.showfullscreenbutton) {
                        if ("center" == this.options.imagetoolboxstyle) {
                            var b =
                                Math.round(("bottom" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2);
                            if (6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) b += 45;
                            c(".html5gallery-toolbox-" + this.id, this.$gallery).css({
                                top: b
                            });
                            b = 0;
                            this.options.showplaybutton && 1 == a ? (b += 36, this.isPaused ? (c(".html5gallery-play-" + this.id, this.$gallery).show(), c(".html5gallery-pause-" + this.id, this.$gallery).hide()) : (c(".html5gallery-play-" + this.id, this.$gallery).hide(), c(".html5gallery-pause-" + this.id, this.$gallery).show())) : (c(".html5gallery-play-" +
                                this.id, this.$gallery).hide(), c(".html5gallery-pause-" + this.id, this.$gallery).hide());
                            ...
                            this.options.showfullscreenbutton && 1 == a ? (b += 36, c(".html5gallery-lightbox-" + this.id, this.$gallery).show()) : c(".html5gallery-lightbox-" +
                        ...
                        } else this.options.showplaybutton && 1 == a ? this.isPaused ? (c(".html5gallery-play-" + this.id, this.$gallery).show(), c(".html5gallery-pause-" + this.id, this.$gallery).hide()) : (c(".html5gallery-play-" + this.id, this.$gallery).hide(), c(".html5gallery-pause-" + this.id, this.$gallery).show()) : (c(".html5gallery-play-" + this.id, this.$gallery).hide(),
                        ...
                        this.options.isIE678 ?
                            c(".html5gallery-toolbox-" + this.id, this.$gallery).show() : c(".html5gallery-toolbox-" + this.id, this.$gallery).fadeIn()
                    }
                };
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.responsivefullscreen && 0 < this.container.parent().height() ? (this.options.containerHeight = this.container.parent().height(), this.options.totalHeight = this.options.containerHeight, this.options.height = this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding), 0 < this.options.carouselHeight + this.options.carouselmargin && (this.options.height -= this.options.carouselHeight + this.options.carouselmargin)) : (this.options.height = Math.round(this.options.width * this.options.originalHeight /
                        this.options.originalWidth), this.options.totalHeight = this.options.height + this.options.carouselHeight + this.options.carouselmargin + this.options.headerHeight + 2 * this.options.padding, this.options.containerHeight = this.options.totalHeight);
                    this.container.css({
                        width: this.options.containerWidth,
                        height: this.options.containerHeight
                    });
                    ...
                    this.options.showcarousel && (this.options.carouselWidth = this.options.width,
                        this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.padding + this.options.boxHeight + this.options.carouselmargin);
                    c(".html5gallery-container-" + this.id).css({
                        width: this.options.totalWidth + "px",
                        height: this.options.totalHeight + "px"
                    });
                    ...
                    this.options.showcarousel && (c(".html5gallery-car-" + this.id).css({
                            ...
                            top: this.options.carouselTop + "px"
                        }), a = 4, this.options.slideshadow && (a += 12),
                        c(".html5gallery-car-list-" + this.id).css({
                        ...
                        (d = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)), 1 > d && (d = 1), d = (this.options.width - d * this.options.thumbwidth - (d - 1) * this.options.thumbgap) / 2, c(".html5gallery-thumbs-" + this.id).css({
                            "margin-left": d + "px",
                            width: this.options.width + "px"
                            ...
                            "margin-left": d + "px",
                            width: String(this.elemArray.length *
            ...
            createStyleDefault: function() {
                ...
                this.options.thumbshowtitle && (this.options.thumbheight +=
                ...
                this.options.showcarousel ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.thumbheight + 2 * this.options.thumbmargin, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.padding + this.options.boxHeight + this.options.carouselmargin, this.options.carouselmultirows && (this.options.carouselHeight = Math.ceil(this.options.width /
                    (this.options.thumbwidth + this.options.thumbgap)) * (this.options.thumbheight + this.options.thumbrowgap))) : (this.options.carouselWidth = 0, this.options.carouselHeight = 0, this.options.carouselLeft = 0, this.options.carouselTop = 0, this.options.carouselmargin = 0);
                ...
                var a = 0,
                    d = 0;
                this.options.elemTop = 0;
                "top" == this.options.headerpos ? (d = 0, a = this.options.socialheight, this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos && (this.options.elemTop =
                    0, a = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height, d = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight);
                var b = " .html5gallery-container-" + this.id + " { display:block; position:absolute; left:0px; top:0px; width:" + this.options.totalWidth + "px; height:" + this.options.totalHeight + "px; " + (!this.options.bgimage ? "" : "background:url('" + this.options.skinfolder + this.options.bgimage + "') center top;") + " background-color:" + this.options.bgcolor +
                    ";}";
                this.options.galleryshadow && (b += " .html5gallery-container-" + this.id + " { }");
                var b = b + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px;}"),
                    e = Math.round(this.options.socialheight / 2 - 12),
                    b = b + (" .html5gallery-title-text-" + this.id +
                    ...
                    b = b + (" .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlecss + " .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlelinkcss),
                    b = b + (" .html5gallery-fullscreen-description-" +
                    ...
                    b = b + (" .html5gallery-title-" + this.id + " {display:" + (this.options.titleoverlay && this.options.titleautohide ? "none" : "block") + "; overflow:hidden; position:absolute; left:0px; width:" +
                        this.options.boxWidth + "px; "),
                    b = this.options.titleoverlay ? "top" == this.options.headerpos ? b + "top:0px; height:auto; }" : b + "bottom:0px; height:auto; }" : b + ("top:" + a + "px; height:" + this.options.titleheight + "px; }"),
                    b = b + (" .html5gallery-timer-" + this.id + " {display:block; position:absolute; top:" + String(this.options.elemTop + this.options.height - 2) + "px; left:0px; width:0px; height:2px; background-color:#ccc; filter:alpha(opacity=60); opacity:0.6; }"),
                    b = b + (" .html5gallery-elem-" + this.id + " {display:block; overflow:hidden; position:absolute; top:" +
                        this.options.elemTop + "px; left:0px; width:" + this.options.width + "px; height:" + this.options.height + "px;}");
                this.options.isIE7 || this.options.isIE6 ? (b += " .html5gallery-loading-" + this.id + " {display:none; }", b += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (b += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading-bars.svg') no-repeat top right;}", b += " .html5gallery-loading-center-" +
                ...
                0 < this.options.borderradius && (b += " .html5gallery-elem-" + this.id + " {overflow:hidden; border-radius:" + this.options.borderradius + "px; -moz-border-radius:" + this.options.borderradius + "px; -webkit-border-radius:" + this.options.borderradius + "px;}");
                this.options.slideshadow && (b += " .html5gallery-title-" + this.id + " { padding:4px;}",
                    b += " .html5gallery-timer-" + this.id + " { margin:4px;}", b += " .html5gallery-elem-" + this.id + " { overflow:hidden; padding:4px; }");
                this.options.showcarousel && this.options.carouselmultirows ? (b += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;", b = this.options.carouselbgtransparent ?
                    ...
                    this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}", this.options.thumbshadow && (b += " .html5gallery-tn-" + this.id + " { }"), b += " .html5gallery-tn-selected-" + this.id + " { display:block; float:left; margin-left:0px; margin-right:" + this.options.thumbgap + "px; margin-bottom:" + this.options.thumbrowgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" +
                    this.options.thumbheight + "px;overflow:hidden;}", this.options.thumbshadow && (b += " .html5gallery-tn-selected-" + this.id + " { }"), b += " .html5gallery-tn-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ",
                    ...
                    this.id + " {display:none;}", this.carouselHighlight = function(a, b) {
                        ...
                        var a = c(".html5gallery-thumbs-" + this.id, this.$gallery);
                        if (parseInt(a.css("margin-left")) != -(this.options.thumbTotalWidth -
                        ...
                        var b = c(".html5gallery-car-left-" + this.id,
                                this.$gallery),
            ...
            loadCarousel: function() {
                ...
                for (var b = 0; b < this.elemArray.length; b++) {
                    ...
                    c(e).load(function() {
                        ...
                        c("#html5gallery-tn-" + a.id + "-" + this.data, d).append("<div class='html5gallery-tn-img-" +
                            ...
                            "'>" + a.elemArray[this.data][7] + (a.options.thumbshowdescription ? "<br /><span class='html5gallery-tn-description-" + a.id + "'>" + a.elemArray[this.data][8] + "</span>" : "") + "</div>")
                    });
            ...
            goFullscreen: function() {
                ...
                var h = Math.max(e, c(document).height()),
                    l = Math.min(this.fullscreenWidth / d, this.fullscreenHeight / b);
                1 > l && (d *= l, b *= l);
                e = c(window).scrollTop() + Math.round((e - (b + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
                this.$fullscreen = c("<div class='html5gallery-fullscreen-" + this.id + "' style='position:absolute;top:0px;left:0px;width:" + a + "px;height:" + h + "px;text-align:center;z-index:99999;'><div class='html5gallery-fullscreen-overlay-" +
                ...
                var g = c(".html5gallery-elem-" + this.id, this.$gallery).empty().css({
                    top: 0,
                    position: "relative"
                });
            ...
            slideRun: function(a, d, b, e) {
                ...
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    this.options.shownumbering && (h = this.options.numberingformat.replace("%NUM", this.curElem + 1).replace("%TOTAL", this.elemArray.length) + " " + h);
                    if (this.isFullscreen) {
                        var l = "";
                        this.options.lightboxshowtitle && h && (l += h);
                        this.options.lightboxshowdescription && a && (l += "<div class='html5gallery-fullscreen-description-" + this.id + "'>" + a + "</div>");
                        c(".html5gallery-fullscreen-title-" + this.id, this.$fullscreen).html(l)
                    } else this.options.showtitle && (h = "<div class='html5gallery-title-text-" +
                        this.id + "'>" + h + "</div>", this.options.showdescription && a && (h += "<div class='html5gallery-description-text-" + this.id + "'>" + a + "</div>"), c(".html5gallery-title-" + this.id, this.$gallery).html(h))
                }
                a = this.elemArray[this.curElem][9];
                if (!(0 > a)) {
                    !this.isFullscreen && d ? "always" == this.options.showimagetoolbox ? ("mouseover" == this.options.imagetoolboxmode || "show" == this.options.imagetoolboxmode) && this.showimagetoolbox(a) : "image" == this.options.showimagetoolbox && 1 != a && this.hideimagetoolbox() : "show" == this.options.imagetoolboxmode ?
                    ...
                    (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !b && this.elemArray[this.curElem][12] ? (this.showingPoster = !0, this.showPoster()) :
                        (c(".html5gallery-video-play-" + this.id, f).length && c(".html5gallery-video-play-" + this.id, f).remove(), 1 == a ? this.showImage() : 5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(b, e) : 9 == a ? this.showYoutube(b) : 10 == a ? this.showVimeo(b) : 11 == a ? this.showEmbedVideo(b) : 2 == a && this.showSWF());
                    ...
                    this.elemArray[this.curElem][5] ? (d.css({
                        ...
                        function() {
                            g.elemArray[g.curElem][6] ? window.open(g.elemArray[g.curElem][5], g.elemArray[g.curElem][6]) : window.open(g.elemArray[g.curElem][5])
                        })) : (d.css({
                        cursor: ""
                    }), d.unbind("click"))
                }
            ...
            showImage: function() {
                ...
                c(b).load(function() {
                    ...
                    b = Math.round(b * this.height);
                    var g = d.isFullscreen ? e : d.options.width,
                        f = d.isFullscreen ? b : d.options.height,
                        j = Math.round(g / 2 - e / 2),
                        k = Math.round(f / 2 - b / 2);
                    d.isFullscreen && d.adjustFullscreen(g, f);
                    a.css({
                        width: g,
                        height: f
                    });
                    e = c("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + f + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" +
                        j + "px; top:" + k + "px; max-width:none; max-height:none; width:" + e + "px; height:" + b + "px;' src='" + d.elemArray[d.curElem][2] + "' />" + d.options.watermarkcode + "</div>");
                ...
                c(b).error(function() {
                    ...
                    d.options.googleanalyticsaccount && window._gaq.push(["_trackEvent", "Image",
                        "Error", d.elemArray[d.curElem][7]
                    ])
                });
            ...
            adjustFullscreen: function(a, d, b) {
                ...
                var h = window.innerHeight ? window.innerHeight : c(window).height();
                this.fullscreenHeight = h - 2 * this.fullscreenMargin - this.fullscreenBarH - 2 * this.fullscreenOutsideMargin;
                var g = Math.max(h, c(document).height()),
                    f = Math.min(this.fullscreenWidth /
                        a, this.fullscreenHeight / d);
                1 > f && (a *= f, d *= f);
                h = c(window).scrollTop() + Math.round((h - (d + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
                ...
                b ? (c(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).css({
                ...
                }), c(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).css({
                    width: a,
                    height: d
                    ...
                    height: d + 2 * this.fullscreenMargin + this.fullscreenBarH,
                    top: h
                }, "slow"), c(".html5gallery-fullscreen-elem-" + this.id,
                    this.$fullscreen).animate({
                    width: a + 2 * this.fullscreenMargin,
                    height: d + 2 * this.fullscreenMargin
                }, "slow"), c(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).animate({
                    width: a,
                    height: d
                ...
                c(".html5gallery-fullscreen-play-" +
                    this.id, this.$fullscreen).css("display", this.isPaused && 1 < this.elemArray.length && 1 == this.elemArray[this.curElem][9] ? "block" : "none");
                ...
                c(".html5gallery-elem-video-container-" + this.id, this.$fullscreen).css({
                    width: a + "px",
                    height: d + "px"
                });
                b = this.options.isIPhone ? d - 48 : d;
                c(".html5gallery-elem-video-container-" + this.id, this.$fullscreen).find("video").css({
                    width: a + "px",
                    height: b + "px"
                });
                c("#html5gallery-elem-video-" + this.id, this.$fullscreen).css({
                    width: a + "px",
                    height: d + "px"
                });
                c("#html5gallery-elem-video-" + this.id, this.$fullscreen).attr("width", a);
                c("#html5gallery-elem-video-" + this.id, this.$fullscreen).attr("height",
                    d);
            ...
            showPoster: function() {
                ...
                $preloading = "" === d.html() ? c("<div class='html5gallery-loading-center-" +
                    this.id + "'></div>").appendTo(d) : c("<div class='html5gallery-loading-" + this.id + "'></div>").appendTo(d);
                var b = this,
                ...
                c(g).load(function() {
                    $preloading.remove();
                    var f, g, l;
                    b.isFullscreen ? (f = Math.max(e / this.width, h / this.height), f = 1 < f ? 1 : f, g = e, l = h) : (f = "fill" == b.options.resizemode ? Math.max(b.options.width / this.width, b.options.height / this.height) : Math.min(b.options.width / this.width, b.options.height / this.height), g = b.options.width,
                        l = b.options.height);
                    var j = Math.round(f * this.width);
                    f = Math.round(f * this.height);
                    var k = Math.round(g / 2 - j / 2),
                        p = Math.round(l / 2 - f / 2);
                    b.isFullscreen && b.adjustFullscreen(g, l);
                    d.css({
                        width: g,
                        height: l
                    });
                    g = c("<div class='html5gallery-elem-img-" + b.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + l + "px; left:0px; margin-left:" + (b.options.slideshadow && !b.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (b.options.slideshadow && !b.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" +
                        b.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + k + "px; top:" + p + "px; max-width:none; max-height:none; width:" + j + "px; height:" + f + "px;' src='" + b.elemArray[b.curElem][12] + "' />" + b.options.watermarkcode + "</div>");
                    l = c(".html5gallery-elem-img-" + b.id, d);
                    l.length ? (d.prepend(g), d.html5boxTransition(b.id, l, g, {
                ...
                c(g).error(function() {
                    ...
                    d.html("<div class='html5gallery-elem-error-" + b.id + "' style='display:block; position:absolute; overflow:hidden; text-align:center; width:" + b.options.width + "px; left:0px; top:" + Math.round(b.options.height /
                        2 - 10) + "px; margin:4px;'><div class='html5gallery-error-" + b.id + "'>The requested content cannot be found</div>");
            ...
            showVideo: function(a, d) {
                ...
                var b = this.isFullscreen ? this.$fullscreen : this.$gallery,
                    e = this.elemArray[this.curElem][10],
                    h = this.elemArray[this.curElem][11];
                this.isFullscreen ? this.adjustFullscreen(e, h) : (c(".html5gallery-elem-" +
                    this.id, this.$gallery).css({
                    width: this.options.width,
                    height: this.options.height
                }), e = this.options.width, h = this.options.height);
                var g = -1;
                d && c(".html5gallery-elem-" + this.id, b).find("video").length && (g = c(".html5gallery-elem-" + this.id, b).find("video:first").get(0).currentTime);
                c(".html5gallery-elem-" + this.id, b).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div class='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow &&
                    !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + h + "px;'></div>" + this.options.watermarkcode);
                this.isHTML5 = !1;
            ...
            showSWF: function() {
                ...
                c(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-elem-flash-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + e + "px;left:" + h + "px;width:" + d + "px;height:" + b + "px;'></div>" + this.options.watermarkcode);
            ...
            prepareYoutubeHref: function(a) {
                var c = a.match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2],
                    c = ("https:" == document.location.protocol ? "https:" : "http:") + "//www.youtube.com/embed/" + c;
            ...
            initYoutubeApi: function() {
                var a, c = !1,
                    b = !1;
                for (a = 0; a < this.elemArray.length; a++) 9 == this.elemArray[a][9] ? c = !0 : 10 == this.elemArray[a][9] && (b = !0);
                ...
                b && (a = document.createElement("script"),
                    a.src = this.options.jsfolder + "froogaloop2.min.js", c = document.getElementsByTagName("script")[0], c.parentNode.insertBefore(a, c))
            },
            showEmbedVideo: function(a) {
                ...
                if (h.match(/\:\/\/.*(dai\.ly)/i)) var g = h.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2],
                    h = (h.match(/https\:\/\//i) ?
                        "https" : "http") + "://www.dailymotion.com/embed/video/" + g;
                a && (h = 0 > h.indexOf("?") ? h + "?autoplay=1" : h + "&autoplay=1");
                c("#html5gallery-elem-video-" + this.id, d).html("<iframe width='" + b + "' height='" + e + "' src='" + h + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][7]])
            },
            showYoutube: function(a) {
                ...
                var h = this.elemArray[this.curElem][2];
                c(".html5gallery-elem-" + this.id, d).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow &&
                    !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + b + "px;height:" + e + "px;'></div>" + this.options.watermarkcode);
                var g = this;
                ...
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7) {
                    ...
                    h + "&wmode=transparent&rel=0", c("#html5gallery-elem-video-" + this.id, d).html("<iframe width='" + b + "' height='" + e + "' src='" + h + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][7]])
            },
            showVimeo: function(a) {
                ...
                var l = this.elemArray[this.curElem][2],
                    l = 0 > l.indexOf("?") ? l + "?" : l + "&",
                    l = a && !this.options.isAndroid ? l + "autoplay=1" : l + "autoplay=0",
                    l = l + ("&api=1&player_id=html5gallery_vimeo_" + this.id);
                c(".html5gallery-elem-" +
                ...
                c(".html5gallery-elem-video-" + this.id, b).html("<iframe id='html5gallery_vimeo_" + this.id + "' width='" + e + "' height='" + g + "' src='" + l + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                if ("function" === typeof $f && a && !this.options.isAndroid) {
                    var b = c("#html5gallery_vimeo_" + this.id)[0],
                        f = $f(b),
                        d = this;
            ...
            checkType: function(a) {
                return !a ? -1 : a.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i) ? 1 : a.match(/[^\.]\.(swf)\s*$/i) ? 2 : a.match(/[^\.]\.(mp3)\s*$/i) ? 3 : a.match(/[^\.]\.(pdf)\s*$/i) ?
                    4 : a.match(/\.(flv)(.*)?$/i) ? 5 : a.match(/\.(mp4|m4v)(.*)?$/i) ? 6 : a.match(/\.(ogv|ogg)(.*)?$/i) ? 7 : a.match(/\.(webm)(.*)?$/i) ? 8 : a.match(/\:\/\/.*(youtube\.com)/i) || a.match(/\:\/\/.*(youtu\.be)/i) ? 9 : a.match(/\:\/\/.*(vimeo\.com)/i) ? 10 : a.match(/\:\/\/.*(dailymotion\.com)/i) || a.match(/\:\/\/.*(dai\.ly)/i) ? 11 : 0
            },
            onChange: function() {
            ...
            onSlideshowOver: function() {
                if (this.options.onslideshowover &&
                    window[this.options.onslideshowover] && "function" == typeof window[this.options.onslideshowover]) window[this.options.onslideshowover](this.elemArray[this.curElem])
            },
            ...
            onThumbClick: function() {
                if (this.options.onthumbclick && window[this.options.onthumbclick] && "function" == typeof window[this.options.onthumbclick]) window[this.options.onthumbclick](this.elemArray[this.curElem])
            },
            onVideoEnd: function() {
            ...
            embedHTML5Video: function(a, d, b, e, g, l, f, j) {
            ...
            embedFlash: function(a, d, b, e, g, j) {
        ...
        this.each(function() {
            ...
            var j = {
                ...
                l = {
                    ...
                    titleoverlay: !0,
                    titleautohide: !1,
                    titlecss: " {color:#ffffff; font-size:24px; font-family:'Segoe UI Light_', 'Open Sans Light', Verdana, Arial, Helvetica, sans-serif !important; overflow:hidden; white-space:normal; text-align:center; padding:10px 0px 10px 10px;  background:#000000 transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }",
                    titlecsslink: " a {color:#ffffff;}",
                    descriptioncss: " {color:#ffffff; font-size:16px; font-family:'Segoe UI Light_', 'Open Sans Light', Verdana, Arial, Helvetica, sans-serif !important; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 10px;  background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }",
                    descriptioncsslink: " a {color:#ffffff;}",
                    showcarousel: !0,
                    carouselmargin: 0,
                    carouselbgtransparent: !0,
                    carouselbgcolorstart: "#555555",
                    carouselbgcolorend: "#555555",
                    thumbwidth: 180,
                    thumbheight: 105,
                    thumbgap: 10,
                    thumbmargin: 15,
                    thumbunselectedimagebordercolor: "#555555",
                    thumbimageborder: 0,
                    thumbimagebordercolor: "#555555",
                    thumbshowplayonvideo: !0,
                    thumbshadow: !0,
                    thumbopacity: 0.8,
                    thumbshowtitle: !0,
                    thumbtitlecss: "{text-align:center; color:#ffffff; font-size:16px; font-family:'Segoe UI Light_', 'Open Sans Light', Verdana, Arial, Helvetica, sans-serif !important; overflow:hidden; white-space:nowrap; background-color:#555555 !important}",
                    thumbtitleheight: 34,
                    showimagetoolbox: "show",
                ...
                f = {
                    ...
                    titleheight: 72,
                    titleautohide: !0,
                    titlecss: "{color:#333;font-size:14px;font-family:Armata,sans-serif,Arial;overflow:hidden;text-align:center;padding:16px 8px 4px 8px;}",
                ...
                r = "vertical" == this.options.skin ? c.extend(r, q) : "showcase" == this.options.skin ? c.extend(r, s) : "light" == this.options.skin ? c.extend(r, j) : "gallery" == this.options.skin ? c.extend(r, l) : "gallerywithtext" == this.options.skin ? c.extend(r, f) : "horizontal" == this.options.skin ? c.extend(r, d) : "darkness" == this.options.skin ? c.extend(r, k) : "mediapage" == this.options.skin ? c.extend(r, h) : c.extend(r, d);
            this.options = c.extend(r, this.options);
            this.options.htmlfolder = window.location.href.substr(0, window.location.href.lastIndexOf("/") +
                1);
            if (!this.options.jsfolder || !this.options.jsfolder.length) this.options.jsfolder = p;
            ...
            h = b.options.fm;
            for (d = 1; 5 >= d; d++) h = h.slice(0, d) + h.slice(d + 1);
            j = h.length;
            for (d = 0; 5 > d; d++) h = h.slice(0, j - 9 + d) + h.slice(j - 8 + d);
            this.options.fvm = h; - 1 != this.options.htmlfolder.indexOf(this.options.fvm) && (this.options.fv = !1);
            j = c(window).width();
            if (this.options.screenquery)
                for (d in this.options.screenquery) j <= this.options.screenquery[d].screenwidth && (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight && (this.options.height = this.options.screenquery[d].galleryheight), this.options.screenquery[d].thumbwidth && (this.options.thumbwidth = this.options.screenquery[d].thumbwidth), this.options.screenquery[d].thumbheight && (this.options.thumbheight =
                    this.options.screenquery[d].thumbheight));
...
var html5GalleryObjects = new function() {
    ...
    this.setHd = function(p, s, k) {
        this.objects[p].setHd(s, k)
    };
    this.gotoSlide = function(p, s) {
        "undefined" === typeof s && (s = 0);
        this.objects[s] && this.objects[s].slideRun(p)
    }
};
